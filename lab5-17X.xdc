...
set_property PACKAGE_PIN U18 [get_ports {startPauseButton}]
set_property IOSTANDARD LVCMOS33 [get_ports {startPauseButton}]
##Bank = 14, Pin name = ,					Sch name = BTNU
set_property PACKAGE_PIN T18 [get_ports {ball_big}]
set_property IOSTANDARD LVCMOS33 [get_ports {ball_big}]
##Bank = 14, Pin name = ,	Sch name = BTNL
set_property PACKAGE_PIN W19 [get_ports {paddle_small}]
set_property IOSTANDARD LVCMOS33 [get_ports {paddle_small}]
##Bank = 14, Pin name = ,							Sch name = BTNR
set_property PACKAGE_PIN T17 [get_ports {paddle_big}]
set_property IOSTANDARD LVCMOS33 [get_ports {paddle_big}]
##Bank = 14, Pin name = ,					Sch name = BTND
set_property PACKAGE_PIN U17 [get_ports {ball_small}]
set_property IOSTANDARD LVCMOS33 [get_ports {ball_small}]



##Pmod Header JA
##Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {pdA_down}]
set_property IOSTANDARD LVCMOS33 [get_ports {pdA_down}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {spi_sdata}]
#set_property IOSTANDARD LVCMOS33 [get_ports {spi_sdata}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
#set_property PACKAGE_PIN D17 [get_ports {pdA_up}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pdA_up}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {pdA_up}]
set_property IOSTANDARD LVCMOS33 [get_ports {pdA_up}]
...
#set_property PACKAGE_PIN A14 [get_ports {pdB_up}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pdB_up}]
###Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {pdB_up}]
set_property IOSTANDARD LVCMOS33 [get_ports {pdB_up}]
###Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {pdB_down}]
set_property IOSTANDARD LVCMOS33 [get_ports {pdB_down}]
